...
// if variants request save into database
                    ...
                    if ($client[0]->onesignal_id != null) {
                        ...
                        $response = SiteHelper::sendMessageWeb($onesignal_id,$text,$title,$type, $id);
...
// update into table order to total
            ...
            $order->update(['total' => $total, 'subtotal' => $subtotal]);
    ...
    public function TotalDeliveryCost(Request $request)
    {
        ...
        // التعديل التالي حيكون في سيرفيس انشاء الطلب 
            ...
            return $this->responseWithoutMessageJson(1, $total_cost);
        } else {
    ...
    public function showCart()
    {
        ...
        if ($carts->isEmpty()) {
            ...
            foreach ($carts as $cart) {
                ...
                if ($check_products->quantity >= $quantity) {

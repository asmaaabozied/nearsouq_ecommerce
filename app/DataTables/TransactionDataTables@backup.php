...
class TransactionDatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('transaction_date', function ($model) {
            ...
            ->editColumn('phone', function ($model) {
                ...
                $sql['old_commsion'] = $transaction_debit - $transactions_credit;
        
                $transactions_merchant = Transaction::where('shop_id',$model->id)->where('name_id',3)->where('final_balance','>',0)->where('credit','>',0)->sum('final_balance');
                ...
                return (!empty($payment)) ? $balance  : '0';
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('phone')->title(trans('site.balance')),

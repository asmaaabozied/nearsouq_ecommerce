                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name_ar" class="form-control"
                                               value="{{ $mall->name_ar }}" readonly >
                                    </div>
                                    <div class="col-md-6">
                                        <label>@lang('site.en.name')</label>
                                        <input type="text" name="name_en" class="form-control"
                                               value="{{ $mall->name_en }}" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="owner_name" class="form-control"
                                               value="{{ $mall->owner_name }}" readonly >
                                    </div>
                                    <div class="col-md-6">
                               ...
                               size="10" readonly   >
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="mall_category_id" readonly >
                                ...
                                <option value="0" @if($mall->mall_category_id ==0) selected @endif >@lang('site.nodataselect')</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="visible" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" name="address" class="form-control" value=" {{$mall->address}} "   readonly  >
                                </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
              ...
              <!--                      </div>-->
                        ...
                        <!--  End Of Modal -->
                                ...
                                <input id="searchMapInput" class="mapControls controls" type="text"
                                       placeholder="" name="address2" value="{{$mall->address2 ??''}}"   readonly  >

                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('dashboard.reasons.update', $reason->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="type">
                                            ...
                                            <option value="CustomerApp" @if($reason->type=='CustomerApp')  selected @endif > @lang('site.CustomerApp') </option>
                                            <option value="DeliveryApp" @if($reason->type=='DeliveryApp')  selected @endif> @lang('site.DeliveryApp') </option>

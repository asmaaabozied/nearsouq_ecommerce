							...
							<div class="login-right-wrap">
								...
								<p class="account-subtitle">@lang('site.register_wellcome')</p>
								 ...
								 @include('partials._errors')
								    ...
								    <form method="post" action="{{route('dashboard.save-shop')}}" name="ShopRegisterForm" id="ShopRegisterForm"
                ...
                <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                    ...
                    <div class="form-group">
                        ...
                        <input id="commerical_number" name="commerical_number"
                                maxlength="10"
                               value="{{old('commerical_number')}}" class="form-control"
                               size="10"> {{--Commerical Register Number--}}

<!--<br>-->
<!--      <div class="g-recaptcha" data-sitekey="6Lc_IGkgAAAAANyi_LNndbDtol_BqcIMsfobwEbZ"  ></div>-->
<!--      <br>-->
                        ...
                        <input id="name_ar" name="name_ar"
                               value="{{old('name_ar')}}"
                               class="form-control"
                               placeholder="@lang('site.placehoder_store_name_ar')"
                               required>
                        <br>
                        <label>@lang('site.ShopEnglishName') <span
                                class="text-danger">*</span></label> {{--Shop  English Name--}}
                        <input id="name_en" name="name_en" value="{{old('name_en')}}"
                               placeholder="@lang('site.placehoder_store_name_ar')"
                               class="form-control"
                               required> {{--Shop   Name--}}
                        ...
                        <input id="brand_name_ar" name="brand_name_ar" value="{{old('brand_name_ar')}}"
                               placeholder="@lang('site.placeholder_brand_name_ar')"
                               class="form-control"
                               required>
                        ...
                        <input id="brand_name_en" name="brand_name_en" value="{{old('brand_name_en')}}"
                               placeholder="@lang('site.placeholder_brand_name_en')"
                               class="form-control"
                               required>
...
//       sitekey: "6Lc_IGkgAAAAANyi_LNndbDtol_BqcIMsfobwEbZ"
//     });
//   });
// </script>

                            ...
                            <form action="{{ route('dashboard.banners.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="position">
                                            ...
                                            <option value="TOP"> @lang('site.TOP') </option>
                                            <option value="DOWN"> @lang('site.DOWN') </option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="type">
                                            <option>@lang('site.select')</option>
                                            <option value="INAPP"> @lang('site.INAPP') </option>
                                            <option value="OUTSIDE_APP"> @lang('site.OUTSIDE_APP') </option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="w3review" name="details_ar" rows="4" cols="50" class="form-control">
                       </textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="w3review" name="details_en" rows="4" cols="50" class="form-control">
                                </textarea>
                                    </div>

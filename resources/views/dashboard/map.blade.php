                        ...
                        @include('partials._errors')
                            ...
                            <div class="col-md-12 col-12 mb-20" id="mapdiv">
                                ...
                                <ul id="geoData">
                                    ...
                                    <li>@lang('site.latitude'): <span id="lat-span"></span></span> <input value="{{$user->latitude}}" id="lat"
                                                                                                       name="latitude"
                                                                                                       class="latitude" disabled>
                                    </li>

                                    <li>@lang('site.longitude'): <span id="lon-span"></span> <input value="{{$user->longitude}}" id="lng"
                                                                                                name="longitude"
                                                                                                class="longitude" disabled></li>

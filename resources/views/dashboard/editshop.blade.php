...
<div class="main-wrapper login-body">
 ...
 @include('partials._errors')
                        <form method="post" action="{{route('dashboard.edit-shop',$shop->id)}}" name="ShopRegisterForm" id="ShopRegisterForm"
                ...
                <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                    ...
                    <div class="form-group">
                        ...
                        <input id="commerical_number" name="commerical_number"
                               ...
                               value="{{ $shop->commerical_number }}" class="form-control"
                               size="10" readonly="readonly"> {{--Commerical Register Number--}}
...
@if(auth()->user())
                        ...
                        <input id="name_en" name="name_en" value="{{ $shop->name_en }}"
                        ...
                        <input id="brand_name_ar" name="brand_name_ar" value="{{ $shop->brand_name_ar }}"
                        ...
                        <input id="brand_name_en" name="brand_name_en" value="{{ $shop->brand_name_en}}"
                        ...
                        <textarea class="form-control"  rows="5" id="desc_ar" name="desc_ar"
                                  placeholder="@lang('site.description') " > {{ $shop->desc_ar }}</textarea>


                        <!--   desc_en -->
                        <label for="desc_en">@lang('site.desc_en')<span class="text-danger">*</span></label>
                        <textarea class="form-control"  rows="5" id="desc_en" name="desc_en"
                        >{{ $shop->desc_en }}</textarea>
                    </div>
                ...
                <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="telephone" name="telephone" value="{{$shop->phone}}"
                        ...
                        <input class="form-control" id="mobilephone" name="mobilephone"
                               placeholder="@lang('site.mobilephone')" value="{{$shop->mobilephone}}" maxlength="10"
                ...
                <div id="step-3" class="tab-pane" role="tabpanel" aria-labelledby="step-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="address" name="address" value="{{$shop->address}}"
                               placeholder="@lang('site.description_of_location')">


                        <div class="radio">
                            <label><input type="radio" name="addressType" id="insideMall" value="inside_mall"   @if($shop->mall_id)  checked @endif
                                          class="form-check-input @error('addressType') is-invalid @enderror">@lang('site.inside_mall')
                            </label>
                        </div>
                        <div class="radio">

                            <label><input type="radio" name="addressType" id="outsideMall" value="outside_mall"   @if($shop->latitude && $shop->longitude)  checked @endif
                        ...
                        <div id="mapdiv">
                            ...
                            <ul id="geoData">
                                <li>@lang('site.latitude'): <span id="lat-span"></span>
                                    <input  id="lat" name="latitude" class="latitude" value="{{$shop->latitude}}">
                                </li>

                                <li>@lang('site.longitude'): <span id="lon-span"></span>
                                    <input id="lng" name="longitude" class="longitude" value="{{$shop->longitude}}"></li>
                            </ul>
                ...
                <div id="step-4" class="tab-pane" role="tabpanel" aria-labelledby="step-4">
                    ...
                    <span class="btn  fileinput-button" style="display:block">
                           <label> @lang('site.file') </label>
{{--                           <a href="{{asset('uploads/shops/profiles/'.$shop->commerical_img)}}">--}}
                         <img class="img-fluid logo-dark mb-2" src="{{asset('uploads/shops/profiles/'.$shop->commerical_img)}}" width="100px" height="100px" class="data open-AddBookDialog" data-bs-toggle="modal" data-bs-target="#exampleModals" data-id="{{$shop->commerical_img}}">
{{--                        </a>--}}
                        <!--<label> @lang('site.file') </label>-->
                        <!--<input class="form-control" type="file" name="commerical_file" id="commerical_file"-->
...
{{--                              <a href="{{asset('uploads/shops/profiles/'.$shop->vat_img)}}">--}}
                            <img class="img-fluid logo-dark mb-2" src="{{asset('uploads/shops/profiles/'.$shop->vat_img)}}"  width="100px" height="100px" class="data open-AddBookDialog" data-bs-toggle="modal" data-bs-target="#exampleModals" data-id="{{$shop->vat_img}}">
{{--                            </a>--}}
                        <!--<label> @lang('site.tax_file') </label>-->
                        <!--<input class="form-control" type="file" name="tax_file" id="tax_file"-->
        ...
        <label>@lang('site.mainimage')</label>
         ...
         <img class="img-fluid logo-dark mb-2" src="{{asset('uploads/shops/profiles/'.$shop->image)}}"  width="100px" height="100px" class="data open-AddBookDialog" data-bs-toggle="modal" data-bs-target="#exampleModals" data-id="{{$shop->image}}">
        <input type="file" name="image" class="form-control"
               value="{{ old('image') }}">
                        ...
                        <label class="form-check-label" for="terms">
                            <a href="{{url('dashboard/terms')}}" target="_blank">@lang('site.termcondition')</a>
                        </label>
...
<script type="text/javascript">
    ...
    <script>
        $(document).ready(function () {
            {{--        {{asset('uploads/shops/profiles/'.$shop->commerical_img)}}--}}
            $(".open-AddBookDialog").click(function () {
                console.log($(this).data('id'))
                // $('.images').src();
                $(".images").attr("src",'{{asset('uploads/shops/profiles/')}}/'+$(this).data('id'));
                // $('.images').src($(this).data('id'));
